        ...
        <div class="bigBoxItem">
          ...
          <div class="select">
            <div
              ...
              v-for="(item, index) in colors"
              :key="index"
              @click="selectBodyColor(index)"
            >
              <div
                class="select-item-color1"
                :style="{ backgroundColor: item }"
              ></div>
            </div>
          </div>
...
let selectHoodColor = (index) => {
  hoodMaterial.color.set(colors[index]);
};
let selectFrontColor = (index) => {
  frontMaterial.color.set(colors[index]);
};
let selectBodyColor = (index) => {
  bodyMaterial.color.set(colors[index]);
};
let selectWheelColor = (index) => {
  wheelsMaterial.color.set(colors[index]);
};
